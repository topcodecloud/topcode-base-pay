//package cloud.topcode.open.pay.plugin.alipay;
//
//import cloud.topcode.open.pay.entity.BaseGoodDetail;
//import cloud.topcode.open.pay.entity.BaseOrder;
//import cloud.topcode.open.pay.entity.PayType;
//import cloud.topcode.open.pay.plugin.alipay.constant.AliConstant;
//import cloud.topcode.open.pay.plugin.alipay.constant.AliMessage;
//import cloud.topcode.open.pay.plugin.alipay.entity.AlipayBaseParam;
//import cloud.topcode.open.pay.plugin.alipay.entity.TradeStatus;
...
//
//import static cloud.topcode.open.pay.util.BaseUtils.getYuanFromFen;
//
//
///**
// * @author Jon
...
//
//    private AlipayBaseParam param;
//    AlipayHandler(AlipayBaseParam p){
//        param.setAlipayPublicKey(p.getAlipayPublicKey());
//        param.setHasDev(p.getHasDev());
//        param.setHasEncrypt(p.getHasEncrypt());
//        param.setUrlGateway(p.getUrlGateway());
//        param.setAppid(p.getAppid());
//        param.setAppPrivateKey(p.getAppPrivateKey());
//        param.setAppPublicKey(p.getAppPublicKey());
//        param.setEncryptType(p.getEncryptType());
//        param.setPayNotifyUrl(p.getPayNotifyUrl());
//        param.setPayReturnUrl(p.getPayReturnUrl());
//    }
//    /**
//     * 支付宝WAP支付
//     *
...
//            request.setReturnUrl(param.getPayReturnUrl());
//            request.setBizModel(createPayParam(order));
//            request.setNeedEncrypt(param.getHasEncrypt());
...
//
//        boolean b = AlipaySignature.rsaCheckV1(map,param.getAlipayPublicKey(), AliConstant.CHARSET,AliConstant.SIGN_TYPE);
//        if (b) {
...
//        return AlipaySignature.rsaCheckV1(map, param.getAlipayPublicKey(), AliConstant.CHARSET, AliConstant.SIGN_TYPE);
//    }
//
//    /**
//     * 获取回调map
...
//                d.setPrice(getYuanFromFen(bd.getPrice()));
